...
function xmldb_alternative_upgrade($oldversion) {
    ...
    // for demonstrative purposes and to show how the alternative
    // iself has been upgraded.

    // For each upgrade block, the file alternative/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field intro to be added to alternative
        $table = new xmldb_table('alternative');
        ...
        // Define field introformat to be added to alternative
        $table = new xmldb_table('alternative');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'alternative');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to alternative
        $table = new xmldb_table('alternative');
        ...
        // Define field timemodified to be added to alternative
        $table = new xmldb_table('alternative');
        ...
        // Define index course (not unique) to be added to alternative
        $table = new xmldb_table('alternative');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'alternative');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'alternative');
    }
