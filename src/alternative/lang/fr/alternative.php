...
$string['synthlimitplaces'] = 'Options à places ind. limitées';
$string['synthunlimitplaces'] = 'Options à places ind. illimitées';
$string['synthlimitteamplaces'] = 'Options à places (équipe) limitées';
$string['synthunlimitteamplaces'] = 'Options à places (équipe) illimitées';
$string['synthplaces'] = 'Places (individuelles)';
$string['synthteamplaces'] = 'Places (équipes)';
